...
const createIconComponent = (displayName: string) => {
  const IconComponent = (props: React.SVGProps<SVGSVGElement>) => {
    return (
      <svg
        ...
        {...props}
      >
        {/* Different path based on icon type */}
        {displayName === 'BarChart3' && (
          <>
        ...
        {displayName === 'TikTok' && (
          <>
            <path d="M9 12a4 4 0 1 0 0 8 4 4 0 0 0 0-8zm10-9v5a6 6 0 0 1-3-.75v4.25a7.5 7.5 0 1 1-7.5-7.5h1v4.75a6 6 0 0 1 3 .75V3h6.5z"></path>
          </>
        )}
...
export const TikTok = createIconComponent('TikTok');
